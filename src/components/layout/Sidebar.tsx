...
export function Sidebar({ tipoEnlaceActivo, setTipoEnlaceActivo, onAutoLayout, mostrarLeyendas, onToggleLeyendas }: Props) {
  ...
  return (
    <aside className="
      w-52 flex-shrink-0 flex flex-col overflow-y-auto
      bg-[#EDF2FA] dark:bg-[#161b27]
      border-r border-[#BFD0E8] dark:border-[#2a3349]
    ">
      {/* Dispositivos */}
      <p className="text-xs font-semibold text-gray-600 dark:text-[#5a6380] uppercase tracking-widest px-3 pt-3 pb-1">
        Dispositivos
      </p>
